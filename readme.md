...
5. [git commit --amend: Corrigindo o último commit](git/p0005_corrige_ultimo_commit.md)

6. [Ignorando arquivos no Git](git/p0006_git_ignore.md)

7. [git commit -am: Atualizando um arquivo modificado no Git](git/p0007_add_arquivo_modificado.md)

8. [git diff: Verificando modificações no repositório](git/p0008_diff.md)

9. [Visualizando o commit no modo gráfico](git/p0009_visualiza_grafica.md)
...
14. [Visualizando grafo de commits](git/p0014_grafo_commit.md)

15. [git checkout: Desfazendo commits](git/p0015_desfaz_commit.md)

16. [git reset: Desfazendo commits](git/p0016_reset_commit.md)

17. [git revert: Desfazendo commits](git/p0017_revert_commit.md)

18. [Usando GitHub](git/p0018_remoto_github.md)
